...
/usr/bin/git --git-dir=$HOME/.dotfiles/ --work-tree=$HOME add .config/bleachbit
...
/usr/bin/git --git-dir=$HOME/.dotfiles/ --work-tree=$HOME add .config/qtile
...
/usr/bin/git --git-dir=$HOME/.dotfiles/ --work-tree=$HOME add .local/share/nemo-python
